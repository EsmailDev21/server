...
@Controller('barber-analytics')
export class BarberAnalyticsController {
  constructor(private readonly prisma: PrismaService) {}

  @Get('numOfCustomers')
  async numberOfCustomers(@Query('barberId') barberId: string) {
    try {
  ...
  @Get('numOfBookings')
  async numberOfBookings(@Query('barberId') barberId: string) {
    try {
  ...
  @Get('totalSales')
  async barberTotalSales(@Query('barberId') barberId: string) {
    try {
  ...
  @Get('weeklySales')
  async barberWeeklySales(@Query('barberId') barberId: string) {
    try {
      const bookings = await this.prisma.booking.findMany({
        where: {
          service: {
  ...
  @Get('monthlySales')
  async barberMonthlySales(@Query('barberId') barberId: string) {
    try {
      const bookings = await this.prisma.booking.findMany({
        where: {
          service: {
  ...
  async barberCustomerInsights(@Query('barberId') barberId: string) {
    try {
  ...
  @Get('serviceRatings')
  async barberServiceRatings(@Query('barberId') barberId: string) {
    try {
  ...
  @Get('bookingTrends')
  async barberBookingTrends(@Query('barberId') barberId: string) {
    try {
      const bookings = await this.prisma.booking.findMany({
        where: {
          service: {
  ...
  @Get('performance')
  async barberPerformance(@Query('barberId') barberId: string) {
    try {
  ...
  @Get('topServices')
  async barberTopServices(@Query('barberId') barberId: string) {
    try {
      const services = await this.prisma.service.findMany({
        where: {
          barberId,
  ...
  async barberServiceGenderType(@Query('barberId') barberId: string) {
    try {
